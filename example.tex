...
\begin{document}
  ...
  % The format used to number a box can be modified
  % \RenewDocumentCommand{\jobCounterFormat}{}{\noexpand\Roman{\tcbcounter}}
  \job{
    title = The exiled,
    start = 1970,
    end = 1974,
  ...
  Test~\ref{paper:goodMan} % Numbering is wrong!
  ...
  \publication[
    ...
    reference = {WC23},
    conference = {Dreaming Inside, Youth edition (DIY)},
    year = {2019},
